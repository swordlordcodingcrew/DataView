...
public class DVModelerFrame extends JFrame {
    ...
    protected DVModelerFrame() {
        super(" Cayenne DataView Modeler ");
        ...
        addNewObjEntityViewAction = dvModelerFrameHelper
                .getAddNewObjEntityViewAction();
        ...
        aboutAction = dvModelerFrameHelper.getAboutAction();
        ...
        this.addWindowListener(dvModelerFrameHelper
                .getDVModelerFrameWindowListener());
        
        dvModelerFrameHelper.loadPrefs();
    }
    ...
    private void buildMenuBar() {
        ...
        close.addActionListener(dvModelerFrameHelper
                .getMenuItemCloseActionListener());
        ...
        loadErrors.addActionListener(dvModelerFrameHelper
                .getMenuItemLoadErrorsActionListenr());
        loadErrors.setEnabled(false);
        menuFile.add(loadErrors);

        saveErrors = new JMenuItem("Show Save Errors");
        saveErrors.addActionListener(dvModelerFrameHelper
                .getMenuItemSaveErrorsActionListener());
        ...
        exit.addActionListener(dvModelerFrameHelper
                .getMenuItemExitActionListener());
        menuFile.add(exit);
    ...
    private void buildMainPanel() {
        ...
        dataTabbedPane.putClientProperty(Options.NO_CONTENT_BORDER_KEY,
                Boolean.TRUE);
        dataTabbedPane.putClientProperty(Options.EMBEDDED_TABS_KEY,
                Boolean.TRUE);
        dataTabbedPane.addTab("Views", new ImageIcon(DVModelerFrame.class
                .getResource("images/dataview-node.gif")), viewsScrollPane);

        dataTabbedPane.addTab("Entities", new ImageIcon(DVModelerFrame.class
                .getResource("images/datamap-node.gif")), mapsScrollPane);

        dataTabbedPane.addChangeListener(dvModelerFrameHelper
                .getDataTabbedPaneChangeListener());
        topCardPanel = new CardPanel();
        bottomCardPanel = buildBottomCardPanel();

        fieldsSplitPane = new JSplitPane(JSplitPane.VERTICAL_SPLIT,
                topTile = new JTile(topCardPanel), bottomTile = new JTile(
                        bottomCardPanel));
        fieldsSplitPane.setDividerLocation(300);
        fieldsSplitPane.setBorder(Borders.EMPTY_BORDER);
        BasicSplitPaneDivider divider = ((BasicSplitPaneUI) fieldsSplitPane
                .getUI()).getDivider();
        divider.setBorder(Borders.EMPTY_BORDER);

        splitPane = new JSplitPane(JSplitPane.HORIZONTAL_SPLIT,
                browserTile = new JTile(dataTabbedPane), fieldsSplitPane);
    ...
    private JTree buildDataMapTree() {
        ...
        dataMapTree.addTreeSelectionListener(dvModelerFrameHelper
                .getDataMapTreeTreeSelectionListener());
        return dataMapTree;
    }
    ...
    private JTree buildDataViewTree() {
        ...
        dataViewTree.addTreeSelectionListener(dvModelerFrameHelper
                .getDataViewTreeTreeSelectionListener());
        return dataViewTree;
    }

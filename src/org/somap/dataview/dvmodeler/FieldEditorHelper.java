...
class FieldEditorHelper {
  ...
  FieldEditorHelper(FieldEditor fieldEditor){
    ...
    tooltipField = fieldEditor.getTooltipField();
    tooltipField.getDocument().addDocumentListener(
      new TooltipChangeListener());
  ...
  private void calcTypeComboAction(ActionEvent e){
    ...
    {
        objEntityViewField.setCalcType(CalcTypeEnum.NO_CALC_TYPE_NAME);
    ...
    else if (comboCalcType.equals("Code"))
    {
        objEntityViewField.setCalcType(CalcTypeEnum.CODE_TYPE_NAME);
    ...
    else if (comboCalcType.equals("Lookup"))
    {
      objEntityViewField.setCalcType(CalcTypeEnum.LOOKUP_TYPE_NAME);
  ...
  private class TooltipChangeListener extends BasicDocumentListener {
      public void documentUpdated(String text) {
          tooltipChangeAction(text);
      }
  }

  private void tooltipChangeAction(String tooltip) {
      String fieldTooltip = objEntityViewField.getTooltip();
      if (!tooltip.trim().equals(fieldTooltip)) {
          objEntityViewField.setTooltip(tooltip.trim());
      }
  }
